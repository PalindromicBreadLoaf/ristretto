...
//
// Assembled GX2 shader that implemenst the Wii TEV default combine.
//
// The shader assembly this was built from originates in the SDL2 Wii U video backend
// (devkitPro/SDL, zlib licence, (C) 2022 GaryOderNichts).

#pragma once

#include <stdint.h>

static const uint8_t g_tevModulateShaderGsh[] = {
...
static const uint32_t g_tevModulateShaderGshLen = 1752;
